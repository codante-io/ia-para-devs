        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Tem dúvidas sobre IA e Direito? Quer colaborar conosco? 
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="duvida">Dúvida sobre IA e Direito</option>
            ...
            <div className="space-y-8">
              ...
              {/* Direct Contact */}
              <div className="bg-white rounded-lg shadow-sm p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Contato Direto</h3>
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href="mailto:contato@iaparadevs.com.br" className="text-brand hover:text-brand/80">
              ...
              {/* FAQ Quick Links */}
              <div className="bg-white rounded-lg shadow-sm p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Dúvidas Frequentes</h3>
                <div className="space-y-3">
                  <p className="text-gray-600 text-sm">
                    Antes de entrar em contato, verifique se sua dúvida não está nas perguntas mais comuns:
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li>
                      <span className="font-medium text-gray-900">•</span>
                      <span className="ml-2 text-gray-600">Como a IA está transformando o Direito?</span>
                    </li>
                    <li>
                      <span className="font-medium text-gray-900">•</span>
                      <span className="ml-2 text-gray-600">Questões éticas no uso de IA jurídica</span>
                    </li>
                    <li>
                      <span className="font-medium text-gray-900">•</span>
                      <span className="ml-2 text-gray-600">Regulamentação de IA no Brasil</span>
                    </li>
                    <li>
                      <span className="font-medium text-gray-900">•</span>
                      <span className="ml-2 text-gray-600">Oportunidades de carreira</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Acompanhe nossas novidades e conteúdos sobre IA e Direito:
                </p>
