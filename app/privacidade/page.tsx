      ...
      <div className="space-y-6 text-sm text-muted-foreground">
        ...
        <section>
          ...
          <p>
            ...
            entra em contato conosco ou usa nossos serviços. Isso pode incluir:
          </p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-foreground">4. Segurança dos Dados</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-foreground">5. Cookies e Tecnologias Similares</h2>
          <p>
            Utilizamos cookies e tecnologias similares para melhorar sua experiência, analisar 
            tendências e administrar o site. Você pode controlar o uso de cookies através das 
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-foreground">7. Retenção de Dados</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-foreground">8. Mudanças nesta Política</h2>
          <p>
            Podemos atualizar esta política de privacidade periodicamente. Notificaremos você 
            sobre mudanças significativas publicando a nova política em nosso site com uma 
            nova data de &ldquo;última atualização&rdquo;.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-foreground">10. Lei Aplicável</h2>
          <p>
            Esta política de privacidade é regida pelas leis do Brasil, incluindo a Lei Geral 
            de Proteção de Dados Pessoais (LGPD - Lei 13.709/2018).
          </p>
        </section>
        </div>
        </div>
